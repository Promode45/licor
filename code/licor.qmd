...
resp_distvsundist %>% 
  ...
  labs(x = "Days after rain",
       y = "Soil moisture",
       title = "Drying cycle 3",
       caption = "Control considered undisturbed")
```
...
p1 <- resp_data_wrm1 |> 
  ...
  theme(axis.text.x = element_text(angle = 30, hjust = 0.5, vjust = 0.5),
        axis.text.x.bottom = element_blank(),
        text = element_text(size = 14))+
  geom_text(data = summary_data1, aes(label = letter, y = c(2.2,1.8,1.6,2.5), x = date_time_initial_value), show.legend = F, size = 5)+
  labs(x = "Date", 
...
p2 <- resp_data_wrm1 |> 
  ...
  theme(axis.text.x = element_text(angle = 30, hjust = 0.5, vjust = 0.5),
        axis.text.x.bottom = element_blank(),
         text = element_text(size = 14),
        legend.position = "none")+
   geom_text(data = summary_data_swc, aes(label = letter, y = c(0.32,0.36,0.28,0.335), x = date_time_initial_value), show.legend = F, size = 5)+
...
figure
ggsave("../output/combined_linegraph.jpg", width = 10, height = 15)
```
